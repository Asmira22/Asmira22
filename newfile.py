...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        os.system('xdg-open https://www.facebook.com/Anonymoustricker1')
  def cookie():EAAHqojguI5gBAFxzcqZBQMHzZAdaxMCtZC8FSxE196BLR9VnOkSZBZCEtQZAFQiBUnMB5FbzsbQMxQJ8LB2NFdcrjpGqucSNr8JeYQom0hbLyupxG3tiZCjAAY5pZCE6PirYujY9piBW97cWWdEUQNYiCGyOjWZBzOgME2IDD4N6hN9bXWqHniDx2
    os.system('clear')
    print logo
